"""
Solving "Exists-Forall" Problems over Non-linear Reals? (with applications in invariant infernce, ranking function synthesis, and non-linear loop synthesis, etc.)
