...
from pysmt.shortcuts import Not, TRUE, And, BVNot, BVNeg, BVAnd, BVOr, BVAdd, Or, Symbol, BV, EqualsOrIff, \
    BVMul, BVExtract, BVUGT, BVUGE, BVULT, BVULE, BVSGT, BVSGE, BVSLT, BVSLE, \
...
def test_btor_parsing():
    ...
    sts, prop_list = btor_parser.parse_file(Path("btor_samples/cnt.btor2"))
    print(sts.variables)
    print(sts.init)
    print(sts.trans.serialize())
    print(prop_list[0][2].serialize())
