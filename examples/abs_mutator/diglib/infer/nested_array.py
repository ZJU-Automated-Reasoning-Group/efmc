...
class NestedArray(diglib.infer.inv.Inv):

    @beartype
    def __init__(self, rel:str, stat=None):
    ...
    def eval_lambda(inv, idx_info, tc):
        ...
        from diglib.infer.nested_array import ExtFun, MyMiscs
...
class Tree(namedtuple("Tree", ("root", "children", "commute"))):
    ...
    @beartype
    def gen_formula(self, v:int, data:Dict[str, List]):
        """
