...
class Z3:
    ...
    def _process_fs(cls: Type[Z3], 
                    ...
                    and_or_f: Callable[[List[z3.ExprRef]], z3.ExprRef]):
    ...
    @classmethod
    def _and(cls: Type[Z3], fs: List[Union[None, z3.ExprRef]]):
        return cls._process_fs(fs, z3.And)

    @classmethod
    def _or(cls: Type[Z3], fs: List[Union[None, z3.ExprRef]]):
        return cls._process_fs(fs, z3.Or)

    @classmethod
    def is_var(cls: Type[Z3], v: Any):
    ...
    @classmethod
    def get_vars(cls: Type[Z3], f: z3.ExprRef):
        """
        >>> x,y,z = z3.Ints("x y z")
    ...
    @classmethod
    def is_valid(cls: Type[Z3], claim: z3.ExprRef):
        _, stat = cls.get_models(z3.Not(claim), 1)
        return stat == z3.unsat

    @classmethod
    def imply(cls: Type[Z3], fs: List[z3.ExprRef], g: z3.ExprRef):
        """
        >>> var('x y')
        (x, y)
    ...
    @staticmethod
    def to_smt2_str(f: z3.ExprRef, status: str = "unknown", name: str = "benchmark", logic: str = ""):
        v = (z3.Ast * 0)()
    ...
    @classmethod
    def from_smt2_str(cls: Type[Z3], s: str):
    ...
    @classmethod
    def model_str(cls: Type[Z3], m: Union[List, z3.ModelRef], as_str: bool = True):
        """
