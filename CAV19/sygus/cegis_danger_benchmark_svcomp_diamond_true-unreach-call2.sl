...
(define-fun trans ((x (_ BitVec 32)) (y (_ BitVec 32)) (x! (_ BitVec 32)) (y! (_ BitVec 32))) Bool (let ((_let_0 (= y! y))) (let ((_let_1 (bvult x #b00000000000000000000000001100011))) (let ((_let_2 (and _let_0 _let_1))) (or (and (= (bvurem y #b00000000000000000000000000000010) #b00000000000000000000000000000000) (and (= x! (bvadd x #b00000000000000000000000000010100)) _let_2)) (and (= x! (bvsub #b00000000000000000000000000000101 x)) _let_2))))))
