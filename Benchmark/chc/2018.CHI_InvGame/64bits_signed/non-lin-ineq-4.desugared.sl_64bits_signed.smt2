...
(assert (forall ((i (_ BitVec 64)) (j (_ BitVec 64)) (k (_ BitVec 64)) (i! (_ BitVec 64)) (j! (_ BitVec 64)) (k! (_ BitVec 64))) 
       (=> (and (inv i j k) ( and ( bvslt i (_ bv1000 64) ) ( = i! ( bvadd i (_ bv1 64) ) ) ( = j! ( bvadd j (_ bv1 64) ) ) ( = k! ( bvadd k ( bvmul i! j! ) ) ) )) (inv i! j! k!))))
(assert (forall ((i (_ BitVec 64)) (j (_ BitVec 64)) (k (_ BitVec 64))) 
       (=> (inv i j k) ( or ( bvslt i (_ bv1000 64) ) ( bvsle ( bvmul (_ bv1000 64) j ) k ) ))))
(check-sat)
