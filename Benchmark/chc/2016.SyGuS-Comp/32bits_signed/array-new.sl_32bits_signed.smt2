...
(assert (forall ((x (_ BitVec 32)) (y (_ BitVec 32)) (z (_ BitVec 32)) (x! (_ BitVec 32)) (y! (_ BitVec 32)) (z! (_ BitVec 32))) 
       (=> (and (inv x y z) ( or ( and ( = x! ( bvadd x (_ bv1 32) ) ) ( = y! z! ) ( bvsle z! y ) ( bvslt x (_ bv500 32) ) ) ( and ( = x! ( bvadd x (_ bv1 32) ) ) ( = y! y ) ( bvsgt z! y ) ( bvslt x (_ bv500 32) ) ) )) (inv x! y! z!))))
(assert (forall ((x (_ BitVec 32)) (y (_ BitVec 32)) (z (_ BitVec 32))) 
       (=> (inv x y z) ( not ( and ( bvsge x (_ bv500 32) ) ( bvslt z y ) ) ))))
(check-sat)
