...
(assert (forall ((x (_ BitVec 32)) (y (_ BitVec 32)) (x! (_ BitVec 32)) (y! (_ BitVec 32))) 
       (=> (and (inv x y) ( and ( bvuge y (_ bv0 32) ) ( = x! ( bvadd x (_ bv1 32) ) ) ( ite ( bvult x! (_ bv50 32) ) ( = y! ( bvadd y (_ bv1 32) ) ) ( = y! ( bvsub y (_ bv1 32) ) ) ) )) (inv x! y!))))
(assert (forall ((x (_ BitVec 32)) (y (_ BitVec 32))) 
       (=> (inv x y) ( or ( bvuge y (_ bv0 32) ) ( = x (_ bv100 32) ) ))))
(check-sat)
