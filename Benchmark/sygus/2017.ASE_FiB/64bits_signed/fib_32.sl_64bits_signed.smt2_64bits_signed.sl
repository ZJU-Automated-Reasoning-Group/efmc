...
(define-fun pre_fun ((n (_ BitVec 64)) (j (_ BitVec 64)) (i (_ BitVec 64)) (b (_ BitVec 64)) (k (_ BitVec 64))) Bool
       ( and ( bvsgt k #x0000000000000000 ) ( = i j ) ( = n #x0000000000000000 ) ( or ( = b #x0000000000000001 ) ( = b #x0000000000000000 ) ) ))
