...
(define-fun trans_fun ((z! (_ BitVec 64)) (y! (_ BitVec 64)) (x! (_ BitVec 64)) (z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( and ( = x! ( bvadd #x0000000000000001 x ) ) ( = y! ( ite ( bvsge x #x00000000000003e8 ) ( bvadd y #x0000000000000001 ) y ) ) ( = z! ( ite ( bvsge y #x00000000000007d0 ) ( bvadd z #x0000000000000001 ) z ) ) ))
(define-fun post_fun ((z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( not ( and ( bvsle #x00000000000007d0 y ) ( not ( = x z ) ) ) ))
