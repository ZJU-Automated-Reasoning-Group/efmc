...
(define-fun trans_fun ((y! (_ BitVec 64)) (x! (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( = y! ( ite ( bvsge y x ) ( bvadd #x0000000000000001 ( bvnot x ) ) ( bvadd y #x0000000000000002 ) ) ) ) ) ( and ( = x! ( ite ( bvsge y x ) ( bvadd x #x0000000000000001 ) x ) ) a!1 ) ))
(define-fun post_fun ((y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( and ( bvsle #x0000000000000000 x ) ( not ( bvsle ( bvadd #xffffffffffffffff y ) x ) ) ) ) ) ( not a!1 ) ))
