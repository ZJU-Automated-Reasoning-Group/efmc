...
(define-fun trans_fun ((z! (_ BitVec 32)) (x! (_ BitVec 32)) (z (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( let ( ( a!1 ( = x! ( ite ( bvult ( bvudiv x #x0000000a ) z ) ( bvadd x #x00000001 ) ( bvsub x #x00000001 ) ) ) ) ( a!2 ( = z! ( ite ( bvult ( bvudiv x #x0000000a ) z ) ( bvsub z #x00000001 ) ( bvadd z #x00000001 ) ) ) ) ) ( and a!1 a!2 ) ))
