...
(define-fun trans_fun ((sn! (_ BitVec 32)) (i! (_ BitVec 32)) (sn (_ BitVec 32)) (i (_ BitVec 32))) Bool
       ( and ( = i! ( bvadd i #x00000001 ) ) ( bvule i #x00000008 ) ( = sn! ( bvadd sn #x00000001 ) ) ))
(define-fun post_fun ((sn (_ BitVec 32)) (i (_ BitVec 32))) Bool
       ( or ( = sn #x00000000 ) ( = sn #x00000008 ) ( and ( = ( ( _ extract (_ bv31 32) (_ bv4 32) ) i ) #x0000000 ) ( bvule ( ( _ extract (_ bv3 32) (_ bv0 32) ) i ) #x8 ) ) ))
