...
(let ((.def_80 (bvslt j__7$main n__1$main)))
...
(let ((.def_13 (not .PC.1)))
(let ((.def_78 (and .PC.0 .def_13)))
(let ((.def_61 (not .PC.2)))
(let ((.def_79 (and .def_61 .def_78)))
(let ((.def_93 (and .def_79 .def_92)))
(let ((.def_69 (bvadd (_ bv1 32) k__5$main)))
(let ((.def_70 (= k__5$main.next .def_69)))
