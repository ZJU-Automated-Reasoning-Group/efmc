...
(define-fun post_fun ((z (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( let ( ( a!1 ( not ( and ( = ( ( _ extract (_ bv31 32) (_ bv7 32) ) z ) #b0000000000000000000000000 ) ( bvule ( ( _ extract (_ bv6 32) (_ bv0 32) ) z ) #b1100100 ) ) ) ) ) ( or ( and ( = ( ( _ extract (_ bv31 32) (_ bv7 32) ) z ) #b0000000000000000000000000 ) ( bvule ( ( _ extract (_ bv6 32) (_ bv0 32) ) z ) #b1100100 ) ) ( and ( not ( bvule #x00000064 x ) ) a!1 ) ( bvule #x00000064 x ) ) ))
