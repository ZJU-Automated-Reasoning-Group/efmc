...
(define-fun trans_fun ((k! (_ BitVec 64)) (j! (_ BitVec 64)) (i! (_ BitVec 64)) (k (_ BitVec 64)) (j (_ BitVec 64)) (i (_ BitVec 64))) Bool
       ( and ( bvslt k #x000000000fffffff ) ( = i! ( bvadd i #x0000000000000001 ) ) ( = j! ( bvadd j #x0000000000000002 ) ) ( = k! ( bvadd k #x0000000000000003 ) ) ))
(define-fun post_fun ((k (_ BitVec 64)) (j (_ BitVec 64)) (i (_ BitVec 64))) Bool
       ( or ( not ( bvsle #x000000000fffffff k ) ) ( and ( = k ( bvmul #x0000000000000003 i ) ) ( = j ( bvmul #x0000000000000002 i ) ) ) ))
