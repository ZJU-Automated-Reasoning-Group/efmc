...
(define-fun trans_fun ((z! (_ BitVec 64)) (y! (_ BitVec 64)) (x! (_ BitVec 64)) (z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( or ( and ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! z! ) ( bvsle z! y ) ( bvslt x #x00000000000001f4 ) ) ( and ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! y ) ( bvsgt z! y ) ( bvslt x #x00000000000001f4 ) ) ) ) ) ( and a!1 ) ))
(define-fun post_fun ((z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( not ( and ( bvsle #x00000000000001f4 x ) ( not ( bvsle y z ) ) ) ))
