...
(define-fun trans_fun ((y! (_ BitVec 32)) (x! (_ BitVec 32)) (y (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( let ( ( a!1 ( = x! ( ite ( bvslt ( bvsdiv x #x00000005 ) #x000000c8 ) ( bvadd x #x00000001 ) ( bvadd x #x00000005 ) ) ) ) ) ( and a!1 ( = y! ( ite ( = x #x000003e8 ) #x00000000 y ) ) ) ))
(define-fun post_fun ((y (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( not ( and ( bvsle #x000007d0 x ) ( not ( = y #x00000000 ) ) ) ))
