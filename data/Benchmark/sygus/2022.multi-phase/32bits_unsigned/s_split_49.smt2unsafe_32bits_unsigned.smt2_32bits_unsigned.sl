...
(define-fun trans_fun ((y! (_ BitVec 32)) (x! (_ BitVec 32)) (y (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( let ( ( a!1 ( = y! ( ite ( bvuge x #x00001d4c ) ( ite ( bvuge x #x000030d4 ) ( bvsub y #x00000002 ) ( bvadd y #x00000001 ) ) ( ite ( bvuge x #x000009c4 ) ( bvadd y #x00000001 ) ( bvsub y #x00000002 ) ) ) ) ) ) ( and ( = x! ( bvadd x #x00000001 ) ) a!1 ) ))
(define-fun post_fun ((y (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( not ( and ( = x #x00003a98 ) ( = y #x00000000 ) ) ))
