...
(define-fun post_fun ((z (_ BitVec 32)) (y (_ BitVec 32)) (x (_ BitVec 32))) Bool
       ( let ( ( a!1 ( not ( and ( = ( ( _ extract (_ bv31 32) (_ bv15 32) ) x ) #b00000000000000000 ) ( bvule ( ( _ extract (_ bv14 32) (_ bv0 32) ) x ) #b100010011110010 ) ) ) ) ( a!2 ( not ( and ( = ( ( _ extract (_ bv31 32) (_ bv15 32) ) z ) #b00000000000000000 ) ( bvule ( ( _ extract (_ bv14 32) (_ bv0 32) ) z ) #b110110000000010 ) ) ) ) ) ( not ( and a!1 a!2 ) ) ))
