...
(assert (forall ((x1 (_ BitVec 32)) (x2 (_ BitVec 32)) (x3 (_ BitVec 32)) (x1! (_ BitVec 32)) (x2! (_ BitVec 32)) (x3! (_ BitVec 32))) 
       (=> (and (inv x1 x2 x3) ( and ( bvule x1! x2! ) ( or ( bvuge x2! (_ bv0 32) ) ( bvule ( bvsub x2! x3! ) (_ bv2 32) ) ) )) (inv x1! x2! x3!))))
(assert (forall ((x1 (_ BitVec 32)) (x2 (_ BitVec 32)) (x3 (_ BitVec 32))) 
       (=> (inv x1 x2 x3) ( and ( bvule x1 x2 ) ( or ( bvuge x2 (_ bv0 32) ) ( bvule ( bvsub x2 x3 ) (_ bv2 32) ) ) ))))
(check-sat)
