...
(assert (forall ((i (_ BitVec 32)) (j (_ BitVec 32)) (k (_ BitVec 32)) (i! (_ BitVec 32)) (j! (_ BitVec 32)) (k! (_ BitVec 32))) 
       (=> (and (inv i j k) ( and ( bvslt k (_ bv268435455 32) ) ( = i! ( bvadd i (_ bv1 32) ) ) ( = j! ( bvadd j (_ bv2 32) ) ) ( = k! ( bvadd k (_ bv3 32) ) ) )) (inv i! j! k!))))
(assert (forall ((i (_ BitVec 32)) (j (_ BitVec 32)) (k (_ BitVec 32))) 
       (=> (inv i j k) ( or ( bvslt k (_ bv268435455 32) ) ( and ( = k ( bvmul (_ bv3 32) i ) ) ( = j ( bvmul (_ bv2 32) i ) ) ) ))))
(check-sat)
