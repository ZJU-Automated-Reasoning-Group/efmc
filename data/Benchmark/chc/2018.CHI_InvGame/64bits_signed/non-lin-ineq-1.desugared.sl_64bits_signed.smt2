...
(assert (forall ((i (_ BitVec 64)) (j (_ BitVec 64)) (k (_ BitVec 64))) 
       (=> ( and ( = i (_ bv0 64) ) ( bvsle ( bvmul i j ) k ) ) (inv i j k))))
(assert (forall ((i (_ BitVec 64)) (j (_ BitVec 64)) (k (_ BitVec 64)) (i! (_ BitVec 64)) (j! (_ BitVec 64)) (k! (_ BitVec 64))) 
       (=> (and (inv i j k) ( and ( bvslt j (_ bv1000 64) ) ( = i! ( bvadd i (_ bv1 64) ) ) ( = j! j ) ( = k! ( bvadd k j ) ) )) (inv i! j! k!))))
(assert (forall ((i (_ BitVec 64)) (j (_ BitVec 64)) (k (_ BitVec 64))) 
       (=> (inv i j k) ( or ( bvslt j (_ bv1000 64) ) ( bvsle ( bvmul i j ) k ) ))))
(check-sat)
