...
(assert (forall ((i (_ BitVec 32)) (j (_ BitVec 32)) (k (_ BitVec 32))) 
       (=> ( and ( = j (_ bv0 32) ) ( = i (_ bv0 32) ) ( bvugt k (_ bv0 32) ) ) (inv i j k))))
(assert (forall ((i (_ BitVec 32)) (j (_ BitVec 32)) (k (_ BitVec 32)) (i! (_ BitVec 32)) (j! (_ BitVec 32)) (k! (_ BitVec 32))) 
       (=> (and (inv i j k) ( and ( bvult j k ) ( = k! k ) ( = j! ( bvadd j (_ bv1 32) ) ) ( = i! ( bvadd i ( bvmul (_ bv2 32) k ) ) ) )) (inv i! j! k!))))
(assert (forall ((i (_ BitVec 32)) (j (_ BitVec 32)) (k (_ BitVec 32))) 
       (=> (inv i j k) ( or ( bvult j k ) ( = i ( bvmul (_ bv2 32) k j ) ) ))))
(check-sat)
