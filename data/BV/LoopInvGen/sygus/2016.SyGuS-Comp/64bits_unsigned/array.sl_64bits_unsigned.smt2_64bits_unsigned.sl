...
(define-fun trans_fun ((z! (_ BitVec 64)) (y! (_ BitVec 64)) (x! (_ BitVec 64)) (z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( or ( and ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! z! ) ( bvule z! y ) ( bvult x #x0000000000000005 ) ) ( and ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! y ) ( bvugt z! y ) ( bvult x #x0000000000000005 ) ) ) ) ) ( and a!1 ) ))
(define-fun post_fun ((z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( not ( and ( bvule #x0000000000000005 x ) ( not ( bvule y z ) ) ) ))
