...
(define-fun pre_fun ((k (_ BitVec 64)) (i (_ BitVec 64))) Bool
       ( and ( = i #x0000000000000000 ) ( bvsle #x0000000000000000 k ) ( bvsle k #x000000000000000a ) ))
(define-fun trans_fun ((k! (_ BitVec 64)) (i! (_ BitVec 64)) (k (_ BitVec 64)) (i (_ BitVec 64))) Bool
       ( and ( bvslt i ( bvmul #x00000000000f4240 k ) ) ( = i! ( bvadd i k ) ) ( = k! k ) ))
(define-fun post_fun ((k (_ BitVec 64)) (i (_ BitVec 64))) Bool
       ( or ( not ( bvsle ( bvmul #x00000000000f4240 k ) i ) ) ( = i ( bvmul #x00000000000f4240 k ) ) ))
