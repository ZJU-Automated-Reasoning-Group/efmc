...
(define-fun trans_fun ((y! (_ BitVec 64)) (x! (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( and ( bvult x #x0000000000000064 ) ( ite ( bvult x #x0000000000000032 ) ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! y ) ) ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! ( bvadd y #x0000000000000001 ) ) ))
(define-fun post_fun ((y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( or ( not ( bvule #x0000000000000064 x ) ) ( = y #x0000000000000064 ) ))
