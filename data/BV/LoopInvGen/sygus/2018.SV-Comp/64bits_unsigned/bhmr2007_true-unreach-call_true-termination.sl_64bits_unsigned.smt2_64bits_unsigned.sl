...
(define-fun trans_fun ((b! (_ BitVec 64)) (a! (_ BitVec 64)) (n! (_ BitVec 64)) (i! (_ BitVec 64)) (b (_ BitVec 64)) (a (_ BitVec 64)) (n (_ BitVec 64)) (i (_ BitVec 64))) Bool
       ( let ( ( a!1 ( or ( and ( = a! ( bvadd a #x0000000000000001 ) ) ( = b! ( bvadd b #x0000000000000002 ) ) ) ( and ( = a! ( bvadd a #x0000000000000002 ) ) ( = b! ( bvadd b #x0000000000000001 ) ) ) ) ) ) ( and ( bvult i n ) a!1 ( = i! ( bvadd i #x0000000000000001 ) ) ( = n! n ) ) ))
