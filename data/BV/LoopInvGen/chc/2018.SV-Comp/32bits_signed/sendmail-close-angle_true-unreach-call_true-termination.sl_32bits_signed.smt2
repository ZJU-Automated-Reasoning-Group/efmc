...
(assert (forall ((in (_ BitVec 32)) (inlen (_ BitVec 32)) (bufferlen (_ BitVec 32)) (buf (_ BitVec 32)) (buflim (_ BitVec 32))) 
       (=> ( and ( bvsgt bufferlen (_ bv1 32) ) ( bvsgt inlen (_ bv0 32) ) ( bvslt bufferlen inlen ) ( = buf (_ bv0 32) ) ( = in (_ bv0 32) ) ( = buflim ( bvsub bufferlen (_ bv2 32) ) ) ) (inv in inlen bufferlen buf buflim))))
...
(assert (forall ((in (_ BitVec 32)) (inlen (_ BitVec 32)) (bufferlen (_ BitVec 32)) (buf (_ BitVec 32)) (buflim (_ BitVec 32))) 
       (=> (inv in inlen bufferlen buf buflim) ( or ( = buf buflim ) ( and ( bvsle (_ bv0 32) buf ) ( bvslt buf bufferlen ) ) ))))
(check-sat)
