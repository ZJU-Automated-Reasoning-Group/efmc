...
(define-fun trans_fun ((w! (_ BitVec 32)) (z! (_ BitVec 32)) (y! (_ BitVec 32)) (x! (_ BitVec 32)) (w (_ BitVec 32)) (x (_ BitVec 32)) (z (_ BitVec 32)) (y (_ BitVec 32))) Bool
       ( let ( ( a!1 ( bvadd ( bvmul ( bvadd #x00000001 ( bvnot #x00000005 ) ) x ) ( bvmul #x00000003 y ) ( bvmul #x00000004 z ) #x00000001 ( bvnot #x00002232 ) ) ) ) ( and ( = x! ( bvsub #x0000000d ( bvmul #x00000007 x ) ) ) ( = y! ( bvsub #x00000036 ( bvmul #x00000002 y ) ) ) ( = z! a!1 ) ( = w! ( ite ( bvsgt z! #x00000000 ) ( bvsub w x ) w ) ) ) ))
(define-fun post_fun ((w (_ BitVec 32)) (x (_ BitVec 32)) (z (_ BitVec 32)) (y (_ BitVec 32))) Bool
       ( not ( and ( bvsle #x00013c12 y ) ( not ( bvsle w #x00000000 ) ) ) ))
