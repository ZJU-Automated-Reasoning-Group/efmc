...
(define-fun trans_fun ((z! (_ BitVec 64)) (y! (_ BitVec 64)) (x! (_ BitVec 64)) (z (_ BitVec 64)) (x (_ BitVec 64)) (y (_ BitVec 64))) Bool
       ( and ( = x! ( bvadd x #x0000000000000001 ) ) ( = y! ( ite ( bvsge x #x0000000000001f40 ) ( bvadd y #x0000000000000001 ) ( bvsub y #x0000000000000001 ) ) ) ( = z! ( ite ( bvslt x #x0000000000001f40 ) ( bvadd z #x0000000000000001 ) ( bvsub z #x0000000000000001 ) ) ) ))
(define-fun post_fun ((z (_ BitVec 64)) (x (_ BitVec 64)) (y (_ BitVec 64))) Bool
       ( let ( ( a!1 ( and ( = x #x0000000000003e80 ) ( not ( and ( = y #x0000000000001f40 ) ( = z #x0000000000000000 ) ) ) ) ) ) ( not a!1 ) ))
