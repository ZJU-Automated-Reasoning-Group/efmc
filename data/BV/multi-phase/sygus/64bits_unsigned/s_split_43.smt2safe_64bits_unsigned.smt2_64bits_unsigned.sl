...
(define-fun trans_fun ((y! (_ BitVec 64)) (x! (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( = y! ( ite ( bvuge x #x0000000002faf080 ) ( ite ( bvuge x #x0000000005f5e100 ) y ( bvadd y #x0000000000000001 ) ) #x0000000000000000 ) ) ) ) ( and ( = x! ( bvadd #x0000000000000001 x ) ) a!1 ) ))
(define-fun post_fun ((y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( not ( and ( bvule #x0000000005f5e100 x ) ( not ( = y #x0000000002faf080 ) ) ) ))
