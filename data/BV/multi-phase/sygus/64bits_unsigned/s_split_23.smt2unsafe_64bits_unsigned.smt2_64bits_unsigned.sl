...
(define-fun trans_fun ((z! (_ BitVec 64)) (x! (_ BitVec 64)) (z (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( = x! ( ite ( bvult ( bvudiv x #x000000000000000a ) z ) ( bvadd x #x0000000000000001 ) ( bvsub x #x0000000000000001 ) ) ) ) ( a!2 ( = z! ( ite ( bvult ( bvudiv x #x000000000000000a ) z ) ( bvsub z #x0000000000000001 ) ( bvadd z #x0000000000000001 ) ) ) ) ) ( and a!1 a!2 ) ))
