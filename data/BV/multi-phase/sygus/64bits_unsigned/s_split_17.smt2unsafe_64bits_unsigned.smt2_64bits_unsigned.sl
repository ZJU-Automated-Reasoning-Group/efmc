...
(define-fun post_fun ((w (_ BitVec 64)) (z (_ BitVec 64)) (x (_ BitVec 64)) (v (_ BitVec 64))) Bool
       ( let ( ( a!1 ( not ( and ( = ( ( _ extract (_ bv63 64) (_ bv10 64) ) v ) #b000000000000000000000000000000000000000000000000000000 ) ( bvule ( ( _ extract (_ bv9 64) (_ bv0 64) ) v ) #b1111101000 ) ) ) ) ) ( not ( and a!1 ( not ( = w #x0000000000000000 ) ) ) ) ))
