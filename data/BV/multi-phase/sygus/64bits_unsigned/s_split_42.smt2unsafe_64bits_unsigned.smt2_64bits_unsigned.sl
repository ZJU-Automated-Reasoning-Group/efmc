...
(define-fun post_fun ((z (_ BitVec 64)) (y (_ BitVec 64)) (x (_ BitVec 64))) Bool
       ( let ( ( a!1 ( not ( and ( = ( ( _ extract (_ bv63 64) (_ bv15 64) ) x ) #b0000000000000000000000000000000000000000000000000 ) ( bvule ( ( _ extract (_ bv14 64) (_ bv0 64) ) x ) #b100010011110010 ) ) ) ) ( a!2 ( not ( and ( = ( ( _ extract (_ bv63 64) (_ bv15 64) ) z ) #b0000000000000000000000000000000000000000000000000 ) ( bvule ( ( _ extract (_ bv14 64) (_ bv0 64) ) z ) #b110110000000010 ) ) ) ) ) ( not ( and a!1 a!2 ) ) ))
