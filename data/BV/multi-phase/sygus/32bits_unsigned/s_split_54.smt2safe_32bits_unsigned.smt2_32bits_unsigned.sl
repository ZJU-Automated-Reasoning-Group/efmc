...
(define-fun trans_fun ((z! (_ BitVec 32)) (y! (_ BitVec 32)) (x! (_ BitVec 32)) (z (_ BitVec 32)) (x (_ BitVec 32)) (y (_ BitVec 32))) Bool
       ( and ( = x! ( bvadd x #x00000001 ) ) ( = y! ( ite ( bvuge x #x00001f40 ) ( bvadd y #x00000001 ) ( bvsub y #x00000001 ) ) ) ( = z! ( ite ( bvult x #x00001f40 ) ( bvadd z #x00000001 ) ( bvsub z #x00000001 ) ) ) ))
(define-fun post_fun ((z (_ BitVec 32)) (x (_ BitVec 32)) (y (_ BitVec 32))) Bool
       ( let ( ( a!1 ( and ( = x #x00003e80 ) ( not ( and ( = y #x00001f40 ) ( = z #x00000000 ) ) ) ) ) ) ( not a!1 ) ))
