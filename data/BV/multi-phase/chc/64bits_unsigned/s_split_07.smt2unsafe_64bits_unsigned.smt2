...
(assert (forall ((z (_ BitVec 64))
         ...
         (y (_ BitVec 64))
         (v (_ BitVec 64)))
  (=> (and (bvugt x y) (bvugt y z) (= v #x0000000000000000)) (inv z x y v))))
(assert (forall ((z (_ BitVec 64))
         (x (_ BitVec 64))
         (y (_ BitVec 64))
         (v (_ BitVec 64))
  ...
  (let ((a!1 (and (inv z x y v)
                  ...
                  (= v! (ite (bvult x y) (bvadd v #x0000000000000001) v)))))
    (=> a!1 (inv x! y! z! v!)))))
(assert (forall ((z (_ BitVec 64))
         (x (_ BitVec 64))
         (y (_ BitVec 64))
  ...
  (let ((a!1 (bvadd z
                    (bvmul (bvadd #x0000000000000001 (bvnot #x0000000000000001))
                           x))))
  (let ((a!2 (not (and (not (bvule a!1 #x0000000000011b53))
                       (not (bvule v #x0000000000000000))))))
    (=> (inv z x y v) a!2)))))
(check-sat)
