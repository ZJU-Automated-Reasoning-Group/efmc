...
(assert (forall ((z (_ BitVec 64))
         ...
         (z! (_ BitVec 64))
         (w! (_ BitVec 64)))
  (let ((a!1 (ite (bvugt (bvsub y (bvmul #x000000000000000a x))
                         #x0000000000000000)
                  (bvadd z #x0000000000000001)
                  z))
        (a!2 (ite (bvugt (bvsub y (bvmul #x000000000000000a x))
                         #x0000000000000000)
                  w
...
(assert (forall ((z (_ BitVec 64))
         ...
         (x (_ BitVec 64))
         (w (_ BitVec 64)))
  (let ((a!1 (not (and (not (bvule x #x0000000000000064)) (not (bvule z w))))))
    (=> (inv z y x w) a!1))))
(check-sat)
