...
class Term(typing.NamedTuple):
    ...
    def __str__(self, use_lambda: bool = False):
        """
    ...
    def eval_traces(self, traces: diglib.data.traces.Traces, pred=None):
        if pred is None:
            return [
    ...
    @staticmethod
    def _eval(lambda_str: str, trace: diglib.data.traces.Trace):
        """
        Examples:
...
class MMP(diglib.infer.inv.Inv):
...
class Infer(diglib.infer.infer._Opt):
    """
