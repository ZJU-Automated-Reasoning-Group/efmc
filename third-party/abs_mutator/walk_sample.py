#!/usr/bin/env python3
"""
The file implements two different MCMC sampling algorithms to generate random points from convex polytopes (bounded regions defined by linear inequalities and equalities):
- Dikin Walk - A more sophisticated algorithm that uses ellipsoidal proposals
- Hit-and-Run - A simpler algorithm that generates random directions
"""
import argparse
